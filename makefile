...
run: simulation.c clean
	...
	gcc -no-pie -o run.a -I/usr/local/include -I/home/PoisFFT/src -L/usr/local/lib/ -L/home/PoisFFT/lib/gcc  simulation.c -Wall -lpoisfft -lm  -lfftw3 -lfftw3f -lfftw3_omp -fopenmp
	touch run
	./run.a
	rm run.a	
